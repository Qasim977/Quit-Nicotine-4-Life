                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            width: 90.w,
                            // color: Colors.purple,
                            child: Text("Street Address", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w300, fontSize: 12.sp),) ,
                          ),
                          Container(
                            height: 7.h,
                            width: 90.w,
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            width: 90.w,
                            // color: Colors.purple,
                            child:  Text("Address Line 2", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w300, fontSize: 12.sp),) ,
                          ),
                          Container(
                            height: 7.h,
                            width: 90.w,
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            width: 90.w,
                            // color: Colors.purple,
                            child: Text("City", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w300, fontSize: 12.sp),) ,
                          ),
                          Container(
                            height: 7.h,
                            width: 90.w,
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            width: 90.w,
                            // color: Colors.purple,
                            child: Text("Post Code", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w300, fontSize: 12.sp),) ,
                          ),
                          Container(
                            height: 7.h,
                            width: 90.w,
                              ...
                              text: TextSpan(
                                ...
                                children: <TextSpan>[
                                  TextSpan(
                                      ...
                                      style: TextStyle(color: kSigninColor, fontWeight: FontWeight.w300, fontSize: 12.sp)),
                                ],
                              ),
                            ),
                          ),
                ...
                child: RaisedButton(
                  ...
                  onPressed: (){
                    if (_formKey.currentState!.validate()) {
                     Navigator.push(context, MaterialPageRoute(builder: (context) => QuestionnaireScreen2(),),);
                    }
                  },
