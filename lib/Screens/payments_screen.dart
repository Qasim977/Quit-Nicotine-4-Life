  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Payments", style: TextStyle(fontSize: 16.sp),),
        actions: [
          ...
          child: Column(
            children: [
              ...
              textAlign: TextAlign.center,
                style: TextStyle(color: Colors.white, height: 1.5, fontSize: 12.sp, fontWeight: FontWeight.w300),
              ),
              SizedBox(height: 3.h,),
              Text("£120.00", style: TextStyle(color: kSigninColor, fontWeight: FontWeight.bold, fontSize: 30.sp),),
              SizedBox(height: 3.h,),
              Form(
                key: _formKey,
                child: Column(
              ...
              Container(
                ...
                child: RaisedButton(
                  ...
                  color: kSignupColor,
                  onPressed: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => WellDoneScreen(),),);
                  },
                  child: Text("Pay Now", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 16.sp),),
                ),
              ),
            ],
          ),
