        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Text("This 120-day programme is designed to assist you with quitting nicotine for good, whilst reducing feelings of anxiety, depression and cravings usually associated with this process. But it also helps you to build yourself back up with strong foundations, to be able to resist going back into a mind state of addiction. As smoking is a habit. And not an addiction.",
              textAlign: TextAlign.justify,
                style: TextStyle(color: Colors.white,height: 1.2 ,fontSize: 11.sp, fontWeight: FontWeight.w400),
              ),
            ),
            SizedBox(height: 3.h,),
            Container(
              ...
              child: Column(
                children: [
                  SizedBox(height: 2.h,),
                  Text("Upon subscribing you will get,", style: TextStyle(color: kSigninColor, fontWeight: FontWeight.w500, fontSize: 13.sp),),
                  BulletList([
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                child: Text("Subscribe Now", style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 16.sp),),
              ),
            ),
          ],
        ),
